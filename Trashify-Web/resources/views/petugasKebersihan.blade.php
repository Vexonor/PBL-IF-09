                    ...
                    <thead class="bg-Genoa text-white">
                        <tr>
                            <th scope="col"
                                ...
                                No.</th>
                            <th scope="col" class="p-3 xl:px-6 xl:py-3 text-xs 2xl:text-sm border-r-2 uppercase">
                                Nama Petugas</th>
                            <th scope="col" class="p-3 xl:px-6 xl:py-3 text-xs 2xl:text-sm border-r-2 uppercase">
                                Wilayah Bertugas</th>
                            <th scope="col" class="px-4 py-3 text-xs 2xl:text-sm border-r-2 uppercase">
                                No. Telepon</th>
                            <th scope="col" class="p-3 xl:px-6 xl:py-3 text-xs 2xl:text-sm border-r-2 uppercase">
                                Status</th>
                            <th scope="col" class="p-3 xl:px-6 xl:py-3 text-xs 2xl:text-sm uppercase">
                                Aksi</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 text-center">
                        ...
                        <tr>
                            <td colspan="6"
                                ...
                                Data Petugas Kebersihan Tidak Tersedia</td>
                        </tr>
                        @else
                        ...
                        <tr class="hover:bg-gray-100">
                            ...
                            <td
                                class="px-4 py-4 text-xs xl:text-sm 2xl:text-base border-r-2 text-gray-800 whitespace-nowrap">
